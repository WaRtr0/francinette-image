...
> [!note]
> Please note, this script was created to be installed on 42-inch computers only. Use the original script for your personal computer [here](https://github.com/xicodomingues/francinette/tree/master#readme).
